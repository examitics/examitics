      ...
      <section className="motorways-hero">
        ...
        <div className="container-custom">
          ...
          <p>
            ...
            Learn all sovereign countries of the world and their
            official capitals through continent-wise tables,
            important facts, frequently asked questions and
            interactive MCQs. This guide is specially prepared
            for PMA Long Course, ISSB, CSS, PMS, FPSC, PPSC,
            ASF, FIA, NTS and other competitive examinations.
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p>
            ...
            Every sovereign country has an officially designated
            capital city that serves as the administrative,
            political and often economic center of the nation.
            Capitals usually host government institutions,
            parliament, supreme courts, embassies and official
          ...
          <p>
            ...
            Questions about countries and their capitals are among
            the most common in General Knowledge examinations.
            Candidates should memorize capitals continent-wise,
            paying special attention to countries whose capitals
            are frequently confused or have changed in recent
            years.
          ...
          <div className="motorway-cards">
            ...
            <div className="motorway-card">
              ...
              <p>
                ...
                Fiji, Samoa and Pacific nations.
        ...
        >
          ...
          <p>
            ...
            It contains more than 45 sovereign countries ranging from
            the Middle East and Central Asia to South Asia,
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Cyprus</td><td>Nicosia</td></tr>

                <tr><td>Georgia</td><td>Tbilisi</td></tr>
                ...
                <tr><td>Iraq</td><td>Baghdad</td></tr>

                <tr><td>Israel</td><td>Jerusalem</td></tr>

                <tr><td>Japan</td><td>Tokyo</td></tr>

                <tr><td>Jordan</td><td>Amman</td></tr>

                <tr><td>Kazakhstan</td><td>Astana</td></tr>
                ...
                <tr><td>Lebanon</td><td>Beirut</td></tr>

                <tr><td>Malaysia</td><td>Kuala Lumpur</td></tr>

                <tr><td>Maldives</td><td>Malé</td></tr>

                <tr><td>Mongolia</td><td>Ulaanbaatar</td></tr>

                <tr><td>Myanmar</td><td>Naypyidaw</td></tr>

                <tr><td>Nepal</td><td>Kathmandu</td></tr>

                <tr><td>North Korea</td><td>Pyongyang</td></tr>

                <tr><td>Oman</td><td>Muscat</td></tr>

                <tr><td>Pakistan</td><td>Islamabad</td></tr>

                <tr><td>Palestine</td><td>Jerusalem (claimed) / Ramallah (administrative)</td></tr>

                <tr><td>Philippines</td><td>Manila</td></tr>

                <tr><td>Qatar</td><td>Doha</td></tr>

                <tr><td>Saudi Arabia</td><td>Riyadh</td></tr>
                ...
                <tr><td>United Arab Emirates</td><td>Abu Dhabi</td></tr>

                <tr><td>Uzbekistan</td><td>Tashkent</td></tr>

                <tr><td>Vietnam</td><td>Hanoi</td></tr>

                <tr><td>Yemen</td><td>Sana'a</td></tr>
        ...
        >
          ...
          <p>
            ...
            Europe is known for its rich history, diverse cultures,
            advanced economies and political institutions. It
            consists of approximately 44 sovereign countries,
            many of which are frequently asked in competitive
            examinations.
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Belarus</td><td>Minsk</td></tr>

                <tr><td>Belgium</td><td>Brussels</td></tr>

                <tr><td>Bosnia and Herzegovina</td><td>Sarajevo</td></tr>

                <tr><td>Bulgaria</td><td>Sofia</td></tr>

                <tr><td>Croatia</td><td>Zagreb</td></tr>

                <tr><td>Czech Republic</td><td>Prague</td></tr>

                <tr><td>Denmark</td><td>Copenhagen</td></tr>
                ...
                <tr><td>Iceland</td><td>Reykjavík</td></tr>
                ...
                <tr><td>Liechtenstein</td><td>Vaduz</td></tr>

                <tr><td>Lithuania</td><td>Vilnius</td></tr>

                <tr><td>Luxembourg</td><td>Luxembourg City</td></tr>

                <tr><td>Malta</td><td>Valletta</td></tr>

                <tr><td>Moldova</td><td>Chișinău</td></tr>
                ...
                <tr><td>North Macedonia</td><td>Skopje</td></tr>
                ...
                <tr><td>Romania</td><td>Bucharest</td></tr>

                <tr><td>Russia</td><td>Moscow</td></tr>

                <tr><td>San Marino</td><td>San Marino</td></tr>

                <tr><td>Serbia</td><td>Belgrade</td></tr>

                <tr><td>Slovakia</td><td>Bratislava</td></tr>
                ...
                <tr><td>Vatican City</td><td>Vatican City</td></tr>
        ...
        <section className="motorways-section exa-card">
          ...
          <div className="important-grid">
            ...
            <div className="important-item">
              🏛️ Brussels is the headquarters of many European Union institutions.
            </div>
        ...
        >
          ...
          <p>
            ...
            Africa is the world's second-largest continent by both
            area and population. It consists of 54 internationally
            recognized sovereign countries and is home to diverse
            cultures, ecosystems and natural resources.
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Burundi</td><td>Gitega</td></tr>

                <tr><td>Cabo Verde</td><td>Praia</td></tr>

                <tr><td>Cameroon</td><td>Yaoundé</td></tr>

                <tr><td>Central African Republic</td><td>Bangui</td></tr>

                <tr><td>Chad</td><td>N'Djamena</td></tr>

                <tr><td>Comoros</td><td>Moroni</td></tr>

                <tr><td>Democratic Republic of the Congo</td><td>Kinshasa</td></tr>

                <tr><td>Republic of the Congo</td><td>Brazzaville</td></tr>
                ...
                <tr><td>Eritrea</td><td>Asmara</td></tr>

                <tr><td>Eswatini</td><td>Mbabane</td></tr>

                <tr><td>Ethiopia</td><td>Addis Ababa</td></tr>

                <tr><td>Gabon</td><td>Libreville</td></tr>

                <tr><td>Gambia</td><td>Banjul</td></tr>

                <tr><td>Ghana</td><td>Accra</td></tr>

                <tr><td>Guinea</td><td>Conakry</td></tr>

                <tr><td>Guinea-Bissau</td><td>Bissau</td></tr>

                <tr><td>Ivory Coast (Côte d'Ivoire)</td><td>Yamoussoukro</td></tr>

                <tr><td>Kenya</td><td>Nairobi</td></tr>

                <tr><td>Lesotho</td><td>Maseru</td></tr>

                <tr><td>Liberia</td><td>Monrovia</td></tr>

                <tr><td>Libya</td><td>Tripoli</td></tr>

                <tr><td>Madagascar</td><td>Antananarivo</td></tr>

                <tr><td>Malawi</td><td>Lilongwe</td></tr>

                <tr><td>Mali</td><td>Bamako</td></tr>

                <tr><td>Mauritania</td><td>Nouakchott</td></tr>

                <tr><td>Mauritius</td><td>Port Louis</td></tr>

                <tr><td>Morocco</td><td>Rabat</td></tr>

                <tr><td>Mozambique</td><td>Maputo</td></tr>

                <tr><td>Namibia</td><td>Windhoek</td></tr>
                ...
                <tr><td>São Tomé and Príncipe</td><td>São Tomé</td></tr>

                <tr><td>Senegal</td><td>Dakar</td></tr>

                <tr><td>Seychelles</td><td>Victoria</td></tr>

                <tr><td>Sierra Leone</td><td>Freetown</td></tr>

                <tr><td>Somalia</td><td>Mogadishu</td></tr>

                <tr><td>South Africa</td><td>Pretoria* (Administrative)</td></tr>
                ...
                <tr><td>Uganda</td><td>Kampala</td></tr>
        ...
        <section className="motorways-section exa-card">
          ...
          <div className="note-box">
            ...
            <p>
              ...
              <strong> Cape Town</strong> (Legislative),
              and <strong> Bloemfontein</strong> (Judicial).
              In most competitive examinations, <strong>Pretoria</strong>
              is accepted as the capital unless the question specifically
              asks about the legislative or judicial capital.
        ...
        >
          ...
          <h2>
            ...
            North & South American Countries and Their Capitals

          </h2>

          <p>

            The Americas consist of North America, Central America,
            the Caribbean and South America. Together they contain
            some of the world's largest economies, longest rivers
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Bahamas</td><td>Nassau</td></tr>
                ...
                <tr><td>Grenada</td><td>Saint George's</td></tr>

                <tr><td>Guatemala</td><td>Guatemala City</td></tr>

                <tr><td>Haiti</td><td>Port-au-Prince</td></tr>
                ...
                <tr><td>Saint Kitts and Nevis</td><td>Basseterre</td></tr>

                <tr><td>Saint Lucia</td><td>Castries</td></tr>

                <tr><td>Saint Vincent and the Grenadines</td><td>Kingstown</td></tr>

                <tr><td>Trinidad and Tobago</td><td>Port of Spain</td></tr>

                <tr><td>United States</td><td>Washington, D.C.</td></tr>
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Bolivia</td><td>Sucre (Constitutional)</td></tr>
        ...
        >
          ...
          <p>
            ...
            Oceania consists of Australia, New Zealand and the
            Pacific island nations. Although it is the smallest
            continent by population, it includes many independent
            island countries that are commonly asked in competitive
            examinations.
          ...
          <div className="motorway-table-wrapper">
            ...
            <table className="motorway-table">
              ...
              <tbody>
                ...
                <tr><td>Kiribati</td><td>South Tarawa</td></tr>
                ...
                <tr><td>Solomon Islands</td><td>Honiara</td></tr>

                <tr><td>Tonga</td><td>Nukuʻalofa</td></tr>

                <tr><td>Tuvalu</td><td>Funafuti</td></tr>

                <tr><td>Vanuatu</td><td>Port Vila</td></tr>
        ...
        <section className="motorways-section exa-card">
          ...
          <h2>
            ...
            Important Facts About the Americas & Oceania
        ...
        <section className="motorways-section exa-card">
          ...
          <h2>
            ...
            Important Facts About Countries and Capitals

          </h2>

          <p>

            Several countries have unique capital arrangements.
            Some have more than one capital city, while others
            have changed their capitals in recent decades.
            These questions are frequently asked in PMA, ISSB,
        ...
        <section className="motorways-section exa-card">
          ...
          <p>
            ...
            Although most countries have one capital city,
            some countries perform different government
        ...
        <section className="motorways-section exa-card">
          ...
          <h2>
            ...
            Countries That Changed Their Capitals

          </h2>

          <p>

            Several countries have moved their capitals for
            administrative, political or economic reasons.
        ...
        <section className="motorways-section exa-card">
          ...
          <p>
            ...
            These are among the most commonly confused capitals in
          ...
          <div className="note-box">
            ...
            <p>
              ...
              Questions about Australia's capital (Canberra),
              Canada's capital (Ottawa), Brazil's capital
              (Brasília), Turkey's capital (Ankara) and
              Switzerland's capital (Bern) appear repeatedly
              in PMA, ISSB and other competitive examinations.
  ...
  <div className="faq-list">
    ...
    <details className="faq-item" open>
      ...
      <p>
        ...
        193 United Nations member states and 2 UN observer states
    ...
    <details className="faq-item">
      ...
      <p>
        ...
        Istanbul, Bern with Zurich, and Washington, D.C. with New York.
      </p>
        ...
        <section className="motorways-section exa-card">
          ...
          <h2>
            ...
            PMA, ISSB & Competitive Exam Tips
          ...
          <ul className="motorway-list">
            ...
            <li>
              ...
              Memorize countries continent-wise instead of trying
              to learn all capitals at once.

            </li>

            <li>

              Focus on capitals that candidates commonly confuse,
              such as Canberra, Ottawa, Brasília, Ankara and Bern.

            </li>

            <li>

              Revise countries with multiple capitals,
              including South Africa, Bolivia,
            ...
            <li>
              ...
              Learn capitals that have changed in recent history,
              including Astana, Naypyidaw and Abuja.
            ...
            <li>
              ...
              Use this guide alongside EXAMITICS mock tests
