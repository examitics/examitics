    ...
    <div className="terms-container">
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          government recruitment organization, armed forces institution, testing
          authority, or examination board unless explicitly stated.
        </p>
      </section>
      ...
      <section className="terms-section">
        ...
        <p>
          Use of EXAMITICS does not guarantee selection, admission, employment,
          recommendation, qualification, or success in any examination,
          recruitment process, interview, ISSB assessment, or military
          selection procedure.
        </p>
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          consequential, or special damages resulting from the use or inability
          to use the platform, including loss of data, examination results,
      ...
      <section className="terms-section">
        ...
        <p>
          ...
          the EXAMITICS contact or support channels available on the platform.
        </p>
      </section>
